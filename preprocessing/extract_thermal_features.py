...
with torch.no_grad():
    ...
    for batch_index, batch in enumerate(
        ...
        batch_size, time_steps, channels, height, width = thermal.shape

        thermal = thermal.reshape(
...
feature_file = os.path.join(
    OUTPUT_DIR,
    "thermal_train_100_features.npy"
)

label_file = os.path.join(
    OUTPUT_DIR,
    "thermal_train_100_labels.npy"
)
...
print("\n" + "=" * 70)
print("THERMAL FEATURE EXTRACTION COMPLETED")
print("=" * 70)
